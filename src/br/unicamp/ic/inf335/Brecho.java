...
public class Brecho {
	...
	public void setProdutos(ArrayList<ProdutoBean> produtos) {
		Brecho.produtos = produtos;
	}
	
	public static void main(String[] args) {
		// Inclui os 6 produtos. 1) instancia Brecho, 2)Cria a lista de produtos atribuindo método get, 3)instancia ProdutoBean e adiciona à lista a cada instância.
		Brecho brecho = new Brecho();
		ArrayList<ProdutoBean> produtos = brecho.getProdutos();
